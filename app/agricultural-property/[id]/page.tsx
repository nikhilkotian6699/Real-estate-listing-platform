...
export default function AgriculturalPropertyDetailsPage({ params }: { params: { id: string } }) {
  ...
  const property = {
    ...
    landmarks: [
      { name: "Market", icon: ShoppingCart, distance: "2.5 km", color: "bg-green-100 text-green-600" },
      { name: "Bank", icon: Hospital, distance: "3.0 km", color: "bg-blue-100 text-blue-600" },
      { name: "Transport", icon: Bus, distance: "1.5 km", color: "bg-orange-100 text-orange-600" },
      { name: "School", icon: School, distance: "4.0 km", color: "bg-purple-100 text-purple-600" },
      { name: "Warehouse", icon: Coffee, distance: "1.0 km", color: "bg-red-100 text-red-600" },
    ],
    description:
      "Premium agricultural land located in the fertile region of Nashik, Maharashtra. This well-maintained farm features black soil ideal for grape and sugarcane cultivation. The property includes modern drip irrigation system, electricity connection, and proper road access. Perfect for serious farmers or agricultural investors looking for high-yield potential. The land comes with organic certification and includes basic farming equipment.",
    seller: {
      name: "Suresh Patil",
      username: "@sureshpatil",
                    ...
                    {property.images.map((image, index) => (
                      <button
                        ...
                        className={`flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 ${
                          index === currentImageIndex ? "border-green-500" : "border-gray-200 dark:border-gray-600"
                        }`}
                      >
                        <Image
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <Square className="w-6 h-6 text-green-600 mb-2" />
                    ...
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <span className="text-xs text-gray-600 dark:text-gray-300">Water Source</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <Sprout className="w-6 h-6 text-green-600 mb-2" />
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                        {property.details.soilType}
                      </span>
                      <span className="text-xs text-gray-600 dark:text-gray-300">Soil Type</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <TreePine className="w-6 h-6 text-green-600 mb-2" />
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                        {property.details.crops}
                      </span>
                      <span className="text-xs text-gray-600 dark:text-gray-300">Crops</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                        {property.details.irrigation}
                      </span>
                      <span className="text-xs text-gray-600 dark:text-gray-300">Irrigation</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <Shield className="w-6 h-6 text-green-600 mb-2" />
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                        {property.details.fencing}
                      </span>
                      <span className="text-xs text-gray-600 dark:text-gray-300">Fencing</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center">
                            ...
                            <span>{relatedProperty.waterSource}</span>
                          </div>
                        </div>

                        <div className="flex items-center">
                          <TreePine className="w-4 h-4 mr-1" />
                          <span className="text-sm">{relatedProperty.crops}</span>
                        </div>
                      </div>

                      <div className="flex items-center justify-between">
                        <div className="text-xl font-bold text-green-600">{relatedProperty.price}</div>
                        <Link href={`/agricultural-property/${relatedProperty.id}`}>
