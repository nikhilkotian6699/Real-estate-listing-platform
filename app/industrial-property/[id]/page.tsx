...
export default function IndustrialPropertyDetailsPage({ params }: { params: { id: string } }) {
  ...
  const property = {
    ...
    details: {
      ...
      machinery: "Included",
      certification: "Pollution Board",
    },
    landmarks: [
      { name: "Highway", icon: Truck, distance: "0.5 km", color: "bg-blue-100 text-blue-600" },
      { name: "Port", icon: ShoppingCart, distance: "15 km", color: "bg-green-100 text-green-600" },
      { name: "Railway", icon: Bus, distance: "3.0 km", color: "bg-orange-100 text-orange-600" },
      { name: "Bank", icon: Building, distance: "2.0 km", color: "bg-purple-100 text-purple-600" },
      { name: "Hospital", icon: Hospital, distance: "5.0 km", color: "bg-red-100 text-red-600" },
    ],
    description:
      "Modern manufacturing unit located in MIDC Aurangabad with excellent connectivity to major highways and ports. This industrial property features heavy-duty power supply, loading docks, and ample space for manufacturing operations. The facility includes pollution board clearance and is suitable for various manufacturing activities. Perfect for established manufacturers looking to expand or new businesses entering the industrial sector.",
    seller: {
      name: "Amit Shah",
      username: "@amitshah",
                    ...
                    {property.images.map((image, index) => (
                      <button
                        ...
                        className={`flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 ${
                          index === currentImageIndex ? "border-purple-500" : "border-gray-200 dark:border-gray-600"
                        }`}
                      >
                        <Image
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <div className="flex items-center space-x-3">
                        <div className="text-3xl font-bold text-purple-600">{property.price}</div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <Square className="w-6 h-6 text-purple-600 mb-2" />
                    ...
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                        {property.details.connectivity}
                      </span>
                      <span className="text-xs text-gray-600 dark:text-gray-300">Connectivity</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <span className="text-xs text-gray-600 dark:text-gray-300">Facilities</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      <Cog className="w-6 h-6 text-purple-600 mb-2" />
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                        {property.details.machinery}
                      </span>
                      <span className="text-xs text-gray-600 dark:text-gray-300">Machinery</span>
                    </div>
                    <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center">
                            ...
                            <span>{relatedProperty.power}</span>
                          </div>
                        </div>

                        <div className="flex items-center">
                          <Truck className="w-4 h-4 mr-1" />
                          <span>{relatedProperty.connectivity}</span>
                        </div>

                        <div className="text-sm">
                          <span className="font-medium">Facilities:</span> {relatedProperty.facilities}
                        </div>
                      </div>

                      <div className="flex items-center justify-between">
                        <div className="text-xl font-bold text-purple-600">{relatedProperty.price}</div>
                        <Link href={`/industrial-property/${relatedProperty.id}`}>
